...
/**
 * OOP Principle: Encapsulation (incremental)
 *
 * Fields remain public final so the three large game panels compile without
 * changes. The getters below are the proper OOP API — panels should prefer
 * these over direct field access. Future refactors can make fields private
 * one at a time once all callers have been migrated.
 *
 * What changed vs the original:
 *   - Added getName(), getBackstory(), getDrawWidth(), getDrawHeight(),
 *     getShadowScale(), getShadowOffsetX(), getSkill2Player2OffsetX(),
 *     getSkill3OffsetX(), getSkill3OffsetY(), getSkill3Scale()
 *     so panels no longer need to read fields directly.
 *   - Added AnimationDef getters (getIdleAnimation, getHurtAnimation, getDeadAnimation)
 *     and DefenseFormDef getter (getDefenseForm).
 *   - All constructors and existing getters are preserved exactly.
 */
public class CharacterDef {
    ...
    public static class ProjectileDef {
        ...
        public ProjectileDef(String sheetPath,
                             ...
                             int speed, int verticalOffset) {
            this(sheetPath, frameWidth, frameHeight, drawWidth, drawHeight, speed, verticalOffset,
                    0, false, false, false, false, 0, 0, 0, 0, null, 0, 0, 0, 0, false, 0);
        }

        public ProjectileDef(String sheetPath,
                             int frameWidth, int frameHeight,
                             int drawWidth,  int drawHeight,
                             int speed, int verticalOffset, int spawnOffsetX) {
            this(sheetPath, frameWidth, frameHeight, drawWidth, drawHeight, speed, verticalOffset,
                    spawnOffsetX, false, false, false, false, 0, 0, 0, 0, null, 0, 0, 0, 0, false, 0);
        }
        ...
        public ProjectileDef(String sheetPath,
                             ...
                             int drawWidth,  int drawHeight,
                             int speed, int verticalOffset, int spawnOffsetX,
                             boolean beam, boolean startDuringCast,
                             boolean anchorOnTargetCenter, boolean anchorOnTarget,
                             int loopStartFrame, int loopEndFrame,
                             int impactStartFrame, int impactEndFrame,
                             String impactSheetPath,
                             int impactFrameWidth, int impactFrameHeight,
                             int impactDrawWidth,  int impactDrawHeight) {
            this(sheetPath, frameWidth, frameHeight, drawWidth, drawHeight, speed, verticalOffset,
                    spawnOffsetX, beam, startDuringCast, anchorOnTargetCenter, anchorOnTarget,
                    loopStartFrame, loopEndFrame, impactStartFrame, impactEndFrame,
                    impactSheetPath, impactFrameWidth, impactFrameHeight,
                    impactDrawWidth, impactDrawHeight, false, 0);
        }
        ...
        public ProjectileDef(String sheetPath,
                             ...
                             int impactFrameWidth, int impactFrameHeight,
                             int impactDrawWidth,  int impactDrawHeight,
                             boolean anchorImpactOnTargetCenter, int animationFrameDelay) {
            this.sheetPath                = sheetPath;
            this.frameWidth               = frameWidth;
            this.frameHeight              = frameHeight;
    ...
    public static class DefenseFormDef {
        ...
        public DefenseFormDef(int toggleSkillSlot, int altSkillSlot,
                              int enterFreezeFrame, int exitStartFrame,
                              AnimationDef altSkillAnimation, ProjectileDef altSkillProjectile) {
    ...
    // ── Fields (public final — existing panel code accesses these directly) ─
    ...
    // ── Constructors (all originals preserved) ────────────────────────────

    public CharacterDef(String name, String backstory,
                        ...
                        String skill1SpritePath, String skill1FollowUpSpritePath,
                        String skill2SpritePath, String skill3SpritePath,
                        int skill1ForwardOffsetX, int skill2ForwardOffsetX, int skill3ForwardOffsetX,
                        double skill1HurtTriggerBufferSeconds, double skill2HurtTriggerBufferSeconds,
        ...
        this(name, backstory,
                ...
                null, null, null, null,
                drawWidth, drawHeight, 0, 0, 0, 0, 1.0, 1.0);
    }
    ...
    public CharacterDef(String name, String backstory,
                        ...
                        double skill3HurtTriggerBufferSeconds,
                        AnimationDef idleAnimation, AnimationDef hurtAnimation, AnimationDef deadAnimation,
                        ProjectileDef skill1Projectile, ProjectileDef skill2Projectile,
                        ProjectileDef skill3Projectile, DefenseFormDef defenseForm,
                        int drawWidth, int drawHeight,
                        int skill2Player2OffsetX, int skill3OffsetX, int skill3OffsetY,
                        int shadowOffsetX, double skill3Scale, double shadowScale) {
        this.name                          = name;
    ...
    public CharacterDef(String name, String backstory,
                        ...
                        AnimationDef idleAnimation, AnimationDef hurtAnimation, AnimationDef deadAnimation,
                        ProjectileDef skill1Projectile, ProjectileDef skill2Projectile,
                        ProjectileDef skill3Projectile,
                        int drawWidth, int drawHeight) {
        this(name, backstory,
                skill1Name, skill2Name, skill3Name,
                skill1Description, skill2Description, skill3Description,
                ...
                skill1HurtTriggerBufferSeconds, skill2HurtTriggerBufferSeconds, skill3HurtTriggerBufferSeconds,
                idleAnimation, hurtAnimation, deadAnimation,
                skill1Projectile, skill2Projectile, skill3Projectile, null,
                drawWidth, drawHeight, 0, 0, 0, 0, 1.0, 1.0);
    }
    ...
    public CharacterDef(String name, String backstory,
        ...
        this(name, backstory,
                ...
                skill1HurtTriggerBufferSeconds, skill2HurtTriggerBufferSeconds, skill3HurtTriggerBufferSeconds,
                idleAnimation, hurtAnimation, deadAnimation,
                skill1Projectile, skill2Projectile, skill3Projectile, defenseForm,
                drawWidth, drawHeight, 0, 0, 0, 0, 1.0, 1.0);
    }
    ...
    // ── Getters (existing + new ones that panels should use) ──────────────
    ...
    public double getShadowScale()          { return shadowScale; }
    public int    getShadowOffsetX()        { return shadowOffsetX; }
    public int    getSkill2Player2OffsetX() { return skill2Player2OffsetX; }
    public int    getSkill3OffsetX()        { return skill3OffsetX; }
    public int    getSkill3OffsetY()        { return skill3OffsetY; }
    public double getSkill3Scale()          { return skill3Scale; }

    public AnimationDef  getIdleAnimation() { return idleAnimation; }
    public AnimationDef  getHurtAnimation() { return hurtAnimation; }
    public AnimationDef  getDeadAnimation() { return deadAnimation; }
    public DefenseFormDef getDefenseForm()  { return defenseForm; }

    public int getSkillPower(int skillID) {
        return switch (skillID) { case 1 -> skill1Power; case 2 -> skill2Power; case 3 -> skill3Power; default -> 0; };
    }
    public String getSkillName(int skillID) {
        return switch (skillID) { case 1 -> skill1Name; case 2 -> skill2Name; case 3 -> skill3Name; default -> "Skill"; };
    }
    public String getSkillSpritePath(int skillID) {
        return switch (skillID) { case 1 -> skill1SpritePath; case 2 -> skill2SpritePath; case 3 -> skill3SpritePath; default -> null; };
    }
    public String getSkillFollowUpSpritePath(int skillID) {
        return switch (skillID) { case 1 -> skill1FollowUpSpritePath; default -> null; };
    }
    public String getSkillType(int skillID) {
        return switch (skillID) { case 1 -> skill1Type; case 2 -> skill2Type; case 3 -> skill3Type; default -> ""; };
    }
    public String getSkillDescription(int skillID) {
        return switch (skillID) { case 1 -> skill1Description; case 2 -> skill2Description; case 3 -> skill3Description; default -> ""; };
    }
    public int getSkillForwardOffsetX(int skillID) {
        return switch (skillID) { case 1 -> skill1ForwardOffsetX; case 2 -> skill2ForwardOffsetX; case 3 -> skill3ForwardOffsetX; default -> 0; };
    }
    public double getSkillHurtTriggerBufferSeconds(int skillID) {
        return switch (skillID) { case 1 -> skill1HurtTriggerBufferSeconds; case 2 -> skill2HurtTriggerBufferSeconds; case 3 -> skill3HurtTriggerBufferSeconds; default -> 0.0; };
    }
    public ProjectileDef getSkillProjectile(int skillID) {
        return switch (skillID) { case 1 -> skill1Projectile; case 2 -> skill2Projectile; case 3 -> skill3Projectile; default -> null; };
    }
}